        ...
        <div className="col-lg-10 border p-3 main-section bg-white">
          <div className="row m-0">
            <div className="col-md-5 left-side-product-box pb-3">
              <img src="https://salt.tikicdn.com/cache/400x400/ts/product/d8/4f/f0/55ad6f5caed5d9d128756112adb852a2.jpg.webp" className="border p-3" />
                <span className="sub-img">
                  <img src="https://salt.tikicdn.com/cache/100x100/ts/product/b4/ff/9a/a57a8d4bd5e1fff5190eb0a2df4f8202.jpg.webp" className="border p-2" alt-text />
                  <img src="https://salt.tikicdn.com/cache/100x100/ts/product/f9/13/f1/e15b24c2449e73cf53c50f6a341731bf.jpg.webp" className="border p-2" alt-text />
                  <img src="https://salt.tikicdn.com/cache/100x100/ts/product/91/6a/59/699d0859c5ce5c33909d7337e96a8025.jpg.webp" className="border p-2" alt-text />
                  <img src="https://salt.tikicdn.com/cache/100x100/ts/product/7f/b3/09/9929ffa5d12b70e18fa077a727fd3c7e.jpg.webp" className="border p-2" alt-text />
                </span>
            </div>
